...
//  __delay_ms(10);// Write 0x04 @ 0x0020
//  EEPROM_Write(0x0036,'B'); 
//  __delay_ms(10);// Write 0x05 @ 0x0021
//  EEPROM_Write(0x0042,'C');     // Write 0x06 @ 0x0022
//  __delay_ms(10); // Wait tWR=10ms For Write To Complete
//  
//  TRISD = 0x00;
//  PORTD = EEPROM_Read(0x0023); // Should Read 0x04
//  __delay_ms(1000);
// PORTD = EEPROM_Read(0x0036); // Should Read 0x05
// __delay_ms(1000);
//  PORTD = EEPROM_Read(0x0042);   // Should Read 0x06
//  __delay_ms(1000);
    while(1)
    {
